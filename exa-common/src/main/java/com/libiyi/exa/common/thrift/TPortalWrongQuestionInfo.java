...
public class TPortalWrongQuestionInfo implements org.apache.thrift.TBase<TPortalWrongQuestionInfo, TPortalWrongQuestionInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TPortalWrongQuestionInfo> {
  ...
  public TPortalWrongQuestionInfo setContent(String content) {
    this.content = content;
    return this;
  }
  ...
  public TPortalWrongQuestionInfo setOptions(String options) {
    this.options = options;
    return this;
  }
  ...
  public TPortalWrongQuestionInfo setAnswer(String answer) {
    this.answer = answer;
    return this;
  }
  ...
  public int compareTo(TPortalWrongQuestionInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetWrongCounts()).compareTo(other.isSetWrongCounts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWrongCounts()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TPortalWrongQuestionInfo(");
    boolean first = true;
