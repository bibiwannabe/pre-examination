...
public class ExaServerService {
  ...
  public interface Iface {
    ...
    public com.libiyi.exa.common.thrift.TRResponse updateUsername(String name, int id) throws org.apache.thrift.TException;
    ...
    public com.libiyi.exa.common.thrift.TRAdminPaperInfoList getAvgLowestFive(int subjectId) throws org.apache.thrift.TException;

    public com.libiyi.exa.common.thrift.TRPaperQuestionDataList getPaperQuestionDataList(int paperId) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void updateUsername(String name, int id, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRResponse> resultHandler) throws org.apache.thrift.TException;
    ...
    public void getAvgLowestFive(int subjectId, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRAdminPaperInfoList> resultHandler) throws org.apache.thrift.TException;

    public void getPaperQuestionDataList(int paperId, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRPaperQuestionDataList> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_updateUsername(String name, int id) throws org.apache.thrift.TException
    {
    ...
    public com.libiyi.exa.common.thrift.TRAdminPaperInfoList getAvgLowestFive(int subjectId) throws org.apache.thrift.TException
    {
      send_getAvgLowestFive(subjectId);
      return recv_getAvgLowestFive();
    }

    public void send_getAvgLowestFive(int subjectId) throws org.apache.thrift.TException
    {
      getAvgLowestFive_args args = new getAvgLowestFive_args();
      args.setSubjectId(subjectId);
      sendBase("getAvgLowestFive", args);
    }

    public com.libiyi.exa.common.thrift.TRAdminPaperInfoList recv_getAvgLowestFive() throws org.apache.thrift.TException
    {
      getAvgLowestFive_result result = new getAvgLowestFive_result();
      receiveBase(result, "getAvgLowestFive");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getAvgLowestFive failed: unknown result");
    }

    public com.libiyi.exa.common.thrift.TRPaperQuestionDataList getPaperQuestionDataList(int paperId) throws org.apache.thrift.TException
    {
      send_getPaperQuestionDataList(paperId);
      return recv_getPaperQuestionDataList();
    }

    public void send_getPaperQuestionDataList(int paperId) throws org.apache.thrift.TException
    {
      getPaperQuestionDataList_args args = new getPaperQuestionDataList_args();
      args.setPaperId(paperId);
      sendBase("getPaperQuestionDataList", args);
    }

    public com.libiyi.exa.common.thrift.TRPaperQuestionDataList recv_getPaperQuestionDataList() throws org.apache.thrift.TException
    {
      getPaperQuestionDataList_result result = new getPaperQuestionDataList_result();
      receiveBase(result, "getPaperQuestionDataList");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getPaperQuestionDataList failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class updateUsername_call extends org.apache.thrift.async.TAsyncMethodCall<com.libiyi.exa.common.thrift.TRResponse> {
      private String name;
      private int id;
      public updateUsername_call(String name, int id, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRResponse> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.name = name;
        this.id = id;
      }
    ...
    public void getAvgLowestFive(int subjectId, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRAdminPaperInfoList> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getAvgLowestFive_call method_call = new getAvgLowestFive_call(subjectId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getAvgLowestFive_call extends org.apache.thrift.async.TAsyncMethodCall<com.libiyi.exa.common.thrift.TRAdminPaperInfoList> {
      private int subjectId;
      public getAvgLowestFive_call(int subjectId, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRAdminPaperInfoList> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.subjectId = subjectId;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getAvgLowestFive", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getAvgLowestFive_args args = new getAvgLowestFive_args();
        args.setSubjectId(subjectId);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public com.libiyi.exa.common.thrift.TRAdminPaperInfoList getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getAvgLowestFive();
      }
    }

    public void getPaperQuestionDataList(int paperId, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRPaperQuestionDataList> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getPaperQuestionDataList_call method_call = new getPaperQuestionDataList_call(paperId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getPaperQuestionDataList_call extends org.apache.thrift.async.TAsyncMethodCall<com.libiyi.exa.common.thrift.TRPaperQuestionDataList> {
      private int paperId;
      public getPaperQuestionDataList_call(int paperId, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRPaperQuestionDataList> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.paperId = paperId;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getPaperQuestionDataList", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getPaperQuestionDataList_args args = new getPaperQuestionDataList_args();
        args.setPaperId(paperId);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public com.libiyi.exa.common.thrift.TRPaperQuestionDataList getResult() throws org.apache.thrift.TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getPaperQuestionDataList();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> java.util.Map<String,  org.apache.thrift.ProcessFunction<I, ? extends org.apache.thrift.TBase>> getProcessMap(java.util.Map<String, org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("getAvgLowestFive", new getAvgLowestFive());
      processMap.put("getPaperQuestionDataList", new getPaperQuestionDataList());
      return processMap;
    }
    ...
    public static class getAvgLowestFive<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getAvgLowestFive_args> {
      public getAvgLowestFive() {
        super("getAvgLowestFive");
      }

      public getAvgLowestFive_args getEmptyArgsInstance() {
        return new getAvgLowestFive_args();
      }
      ...
      public getAvgLowestFive_result getResult(I iface, getAvgLowestFive_args args) throws org.apache.thrift.TException {
        getAvgLowestFive_result result = new getAvgLowestFive_result();
        result.success = iface.getAvgLowestFive(args.subjectId);
        return result;
      }
    }

    public static class getPaperQuestionDataList<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getPaperQuestionDataList_args> {
      public getPaperQuestionDataList() {
        super("getPaperQuestionDataList");
      }

      public getPaperQuestionDataList_args getEmptyArgsInstance() {
        return new getPaperQuestionDataList_args();
      }
      ...
      public getPaperQuestionDataList_result getResult(I iface, getPaperQuestionDataList_args args) throws org.apache.thrift.TException {
        getPaperQuestionDataList_result result = new getPaperQuestionDataList_result();
        result.success = iface.getPaperQuestionDataList(args.paperId);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getAvgLowestFive<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getAvgLowestFive_args, com.libiyi.exa.common.thrift.TRAdminPaperInfoList> {
      public getAvgLowestFive() {
        super("getAvgLowestFive");
      }
      ...
      public void start(I iface, getAvgLowestFive_args args, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRAdminPaperInfoList> resultHandler) throws org.apache.thrift.TException {
        iface.getAvgLowestFive(args.subjectId,resultHandler);
      }
    }

    public static class getPaperQuestionDataList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getPaperQuestionDataList_args, com.libiyi.exa.common.thrift.TRPaperQuestionDataList> {
      public getPaperQuestionDataList() {
        super("getPaperQuestionDataList");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRPaperQuestionDataList> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRPaperQuestionDataList>() { 
          public void onComplete(com.libiyi.exa.common.thrift.TRPaperQuestionDataList o) {
            getPaperQuestionDataList_result result = new getPaperQuestionDataList_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, getPaperQuestionDataList_args args, org.apache.thrift.async.AsyncMethodCallback<com.libiyi.exa.common.thrift.TRPaperQuestionDataList> resultHandler) throws org.apache.thrift.TException {
        iface.getPaperQuestionDataList(args.paperId,resultHandler);
      }
    }
  ...
  public static class updateUsername_args implements org.apache.thrift.TBase<updateUsername_args, updateUsername_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateUsername_args>   {
    ...
    public updateUsername_args setName(String name) {
      this.name = name;
      return this;
    }
  ...
  public static class getSubjectQuestionCount_args implements org.apache.thrift.TBase<getSubjectQuestionCount_args, getSubjectQuestionCount_args._Fields>, java.io.Serializable, Cloneable, Comparable<getSubjectQuestionCount_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getSubjectQuestionCount_args(");
      boolean first = true;
  ...
  public static class getSubjectQuestionCount_result implements org.apache.thrift.TBase<getSubjectQuestionCount_result, getSubjectQuestionCount_result._Fields>, java.io.Serializable, Cloneable, Comparable<getSubjectQuestionCount_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getSubjectQuestionCount_result(");
      boolean first = true;
  ...
  public static class getWrongQuestionBySubjectId_args implements org.apache.thrift.TBase<getWrongQuestionBySubjectId_args, getWrongQuestionBySubjectId_args._Fields>, java.io.Serializable, Cloneable, Comparable<getWrongQuestionBySubjectId_args>   {
    ...
    public int compareTo(getWrongQuestionBySubjectId_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetWorngQuestionParam()).compareTo(other.isSetWorngQuestionParam());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetWorngQuestionParam()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getWrongQuestionBySubjectId_args(");
      boolean first = true;
  ...
  public static class getWrongQuestionBySubjectId_result implements org.apache.thrift.TBase<getWrongQuestionBySubjectId_result, getWrongQuestionBySubjectId_result._Fields>, java.io.Serializable, Cloneable, Comparable<getWrongQuestionBySubjectId_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getWrongQuestionBySubjectId_result(");
      boolean first = true;
  ...
  public static class getPaperListBySubjectId_args implements org.apache.thrift.TBase<getPaperListBySubjectId_args, getPaperListBySubjectId_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPaperListBySubjectId_args>   {
    ...
    public int compareTo(getPaperListBySubjectId_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetQueryPaperInfo()).compareTo(other.isSetQueryPaperInfo());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetQueryPaperInfo()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPaperListBySubjectId_args(");
      boolean first = true;
  ...
  public static class getPaperListBySubjectId_result implements org.apache.thrift.TBase<getPaperListBySubjectId_result, getPaperListBySubjectId_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPaperListBySubjectId_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPaperListBySubjectId_result(");
      boolean first = true;
  ...
  public static class portalGetPaperById_args implements org.apache.thrift.TBase<portalGetPaperById_args, portalGetPaperById_args._Fields>, java.io.Serializable, Cloneable, Comparable<portalGetPaperById_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("portalGetPaperById_args(");
      boolean first = true;
  ...
  public static class portalGetPaperById_result implements org.apache.thrift.TBase<portalGetPaperById_result, portalGetPaperById_result._Fields>, java.io.Serializable, Cloneable, Comparable<portalGetPaperById_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("portalGetPaperById_result(");
      boolean first = true;
  ...
  public static class getEvaluateResult_args implements org.apache.thrift.TBase<getEvaluateResult_args, getEvaluateResult_args._Fields>, java.io.Serializable, Cloneable, Comparable<getEvaluateResult_args>   {
    ...
    public int compareTo(getEvaluateResult_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetPracticeParam()).compareTo(other.isSetPracticeParam());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetPracticeParam()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getEvaluateResult_args(");
      boolean first = true;
  ...
  public static class getEvaluateResult_result implements org.apache.thrift.TBase<getEvaluateResult_result, getEvaluateResult_result._Fields>, java.io.Serializable, Cloneable, Comparable<getEvaluateResult_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getEvaluateResult_result(");
      boolean first = true;
  ...
  public static class getRecommendPaperList_args implements org.apache.thrift.TBase<getRecommendPaperList_args, getRecommendPaperList_args._Fields>, java.io.Serializable, Cloneable, Comparable<getRecommendPaperList_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getRecommendPaperList_args(");
      boolean first = true;
  ...
  public static class getRecommendPaperList_result implements org.apache.thrift.TBase<getRecommendPaperList_result, getRecommendPaperList_result._Fields>, java.io.Serializable, Cloneable, Comparable<getRecommendPaperList_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getRecommendPaperList_result(");
      boolean first = true;
  ...
  public static class getEvaluateResultById_args implements org.apache.thrift.TBase<getEvaluateResultById_args, getEvaluateResultById_args._Fields>, java.io.Serializable, Cloneable, Comparable<getEvaluateResultById_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getEvaluateResultById_args(");
      boolean first = true;
  ...
  public static class getEvaluateResultById_result implements org.apache.thrift.TBase<getEvaluateResultById_result, getEvaluateResultById_result._Fields>, java.io.Serializable, Cloneable, Comparable<getEvaluateResultById_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getEvaluateResultById_result(");
      boolean first = true;
  ...
  public static class getPracticeRecordByUserId_args implements org.apache.thrift.TBase<getPracticeRecordByUserId_args, getPracticeRecordByUserId_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPracticeRecordByUserId_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPracticeRecordByUserId_args(");
      boolean first = true;
  ...
  public static class getPracticeRecordByUserId_result implements org.apache.thrift.TBase<getPracticeRecordByUserId_result, getPracticeRecordByUserId_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPracticeRecordByUserId_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPracticeRecordByUserId_result(");
      boolean first = true;
...
;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getHotestPaperList_args(");
      boolean first = true;
  ...
  public static class getHotestPaperList_result implements org.apache.thrift.TBase<getHotestPaperList_result, getHotestPaperList_result._Fields>, java.io.Serializable, Cloneable, Comparable<getHotestPaperList_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getHotestPaperList_result(");
      boolean first = true;
...
;
  ...
  public static class addQuestion_args implements org.apache.thrift.TBase<addQuestion_args, addQuestion_args._Fields>, java.io.Serializable, Cloneable, Comparable<addQuestion_args>   {
    ...
    public int compareTo(addQuestion_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetQuestionInfo()).compareTo(other.isSetQuestionInfo());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetQuestionInfo()) {
  ...
  public static class getQuestionListByParam_args implements org.apache.thrift.TBase<getQuestionListByParam_args, getQuestionListByParam_args._Fields>, java.io.Serializable, Cloneable, Comparable<getQuestionListByParam_args>   {
    ...
    public int compareTo(getQuestionListByParam_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetQuerryParam()).compareTo(other.isSetQuerryParam());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetQuerryParam()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getQuestionListByParam_args(");
      boolean first = true;
  ...
  public static class getQuestionListByParam_result implements org.apache.thrift.TBase<getQuestionListByParam_result, getQuestionListByParam_result._Fields>, java.io.Serializable, Cloneable, Comparable<getQuestionListByParam_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getQuestionListByParam_result(");
      boolean first = true;
  ...
  public static class getQuestionListBySearchKey_args implements org.apache.thrift.TBase<getQuestionListBySearchKey_args, getQuestionListBySearchKey_args._Fields>, java.io.Serializable, Cloneable, Comparable<getQuestionListBySearchKey_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getQuestionListBySearchKey_args(");
      boolean first = true;
  ...
  public static class getQuestionListBySearchKey_result implements org.apache.thrift.TBase<getQuestionListBySearchKey_result, getQuestionListBySearchKey_result._Fields>, java.io.Serializable, Cloneable, Comparable<getQuestionListBySearchKey_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getQuestionListBySearchKey_result(");
      boolean first = true;
  ...
  public static class modifyQuestion_args implements org.apache.thrift.TBase<modifyQuestion_args, modifyQuestion_args._Fields>, java.io.Serializable, Cloneable, Comparable<modifyQuestion_args>   {
    ...
    public int compareTo(modifyQuestion_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetModifyParam()).compareTo(other.isSetModifyParam());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetModifyParam()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("modifyQuestion_args(");
      boolean first = true;
  ...
  public static class modifyQuestion_result implements org.apache.thrift.TBase<modifyQuestion_result, modifyQuestion_result._Fields>, java.io.Serializable, Cloneable, Comparable<modifyQuestion_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("modifyQuestion_result(");
      boolean first = true;
  ...
  public static class createPaper_args implements org.apache.thrift.TBase<createPaper_args, createPaper_args._Fields>, java.io.Serializable, Cloneable, Comparable<createPaper_args>   {
    ...
    public int compareTo(createPaper_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetPaperInfo()).compareTo(other.isSetPaperInfo());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetPaperInfo()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("createPaper_args(");
      boolean first = true;
  ...
  public static class createPaper_result implements org.apache.thrift.TBase<createPaper_result, createPaper_result._Fields>, java.io.Serializable, Cloneable, Comparable<createPaper_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("createPaper_result(");
      boolean first = true;
  ...
  public static class modifyPaper_args implements org.apache.thrift.TBase<modifyPaper_args, modifyPaper_args._Fields>, java.io.Serializable, Cloneable, Comparable<modifyPaper_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("modifyPaper_args(");
      boolean first = true;
  ...
  public static class modifyPaper_result implements org.apache.thrift.TBase<modifyPaper_result, modifyPaper_result._Fields>, java.io.Serializable, Cloneable, Comparable<modifyPaper_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("modifyPaper_result(");
      boolean first = true;
  ...
  public static class getPaperListByParam_args implements org.apache.thrift.TBase<getPaperListByParam_args, getPaperListByParam_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPaperListByParam_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPaperListByParam_args(");
      boolean first = true;
  ...
  public static class getPaperListByParam_result implements org.apache.thrift.TBase<getPaperListByParam_result, getPaperListByParam_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPaperListByParam_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPaperListByParam_result(");
      boolean first = true;
  ...
  public static class getPaperById_args implements org.apache.thrift.TBase<getPaperById_args, getPaperById_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPaperById_args>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPaperById_args(");
      boolean first = true;
  ...
  public static class getPaperById_result implements org.apache.thrift.TBase<getPaperById_result, getPaperById_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPaperById_result>   {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPaperById_result(");
      boolean first = true;
  ...
  public static class getAvgLowestFive_args implements org.apache.thrift.TBase<getAvgLowestFive_args, getAvgLowestFive_args._Fields>, java.io.Serializable, Cloneable, Comparable<getAvgLowestFive_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getAvgLowestFive_args");
    ...
    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new getAvgLowestFive_argsStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new getAvgLowestFive_argsTupleSchemeFactory();
    ...
    static {
      ...
      tmpMap.put(_Fields.SUBJECT_ID, new org.apache.thrift.meta_data.FieldMetaData("subjectId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getAvgLowestFive_args.class, metaDataMap);
    }

    public getAvgLowestFive_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getAvgLowestFive_args(getAvgLowestFive_args other) {
      __isset_bitfield = other.__isset_bitfield;
      this.subjectId = other.subjectId;
    }

    public getAvgLowestFive_args deepCopy() {
      return new getAvgLowestFive_args(this);
    }
    ...
    public getAvgLowestFive_args setSubjectId(int subjectId) {
      this.subjectId = subjectId;
      setSubjectIdIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getAvgLowestFive_args)
        return this.equals((getAvgLowestFive_args)that);
      return false;
    }

    public boolean equals(getAvgLowestFive_args that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(getAvgLowestFive_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getAvgLowestFive_args(");
      boolean first = true;
    ...
    private static class getAvgLowestFive_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getAvgLowestFive_argsStandardScheme getScheme() {
        return new getAvgLowestFive_argsStandardScheme();
      }
    }

    private static class getAvgLowestFive_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getAvgLowestFive_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getAvgLowestFive_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAvgLowestFive_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getAvgLowestFive_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getAvgLowestFive_argsTupleScheme getScheme() {
        return new getAvgLowestFive_argsTupleScheme();
      }
    }

    private static class getAvgLowestFive_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<getAvgLowestFive_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getAvgLowestFive_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getAvgLowestFive_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.subjectId = iprot.readI32();
  ...
  public static class getAvgLowestFive_result implements org.apache.thrift.TBase<getAvgLowestFive_result, getAvgLowestFive_result._Fields>, java.io.Serializable, Cloneable, Comparable<getAvgLowestFive_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getAvgLowestFive_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRUCT, (short)0);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new getAvgLowestFive_resultStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new getAvgLowestFive_resultTupleSchemeFactory();
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.libiyi.exa.common.thrift.TRAdminPaperInfoList.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getAvgLowestFive_result.class, metaDataMap);
    }

    public getAvgLowestFive_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getAvgLowestFive_result(getAvgLowestFive_result other) {
      if (other.isSetSuccess()) {
        this.success = new com.libiyi.exa.common.thrift.TRAdminPaperInfoList(other.success);
      }
    }

    public getAvgLowestFive_result deepCopy() {
      return new getAvgLowestFive_result(this);
    }
    ...
    public getAvgLowestFive_result setSuccess(com.libiyi.exa.common.thrift.TRAdminPaperInfoList success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getAvgLowestFive_result)
        return this.equals((getAvgLowestFive_result)that);
      return false;
    }

    public boolean equals(getAvgLowestFive_result that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(getAvgLowestFive_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getAvgLowestFive_result(");
      boolean first = true;
    ...
    private static class getAvgLowestFive_resultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getAvgLowestFive_resultStandardScheme getScheme() {
        return new getAvgLowestFive_resultStandardScheme();
      }
    }

    private static class getAvgLowestFive_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getAvgLowestFive_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getAvgLowestFive_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAvgLowestFive_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getAvgLowestFive_resultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getAvgLowestFive_resultTupleScheme getScheme() {
        return new getAvgLowestFive_resultTupleScheme();
      }
    }

    private static class getAvgLowestFive_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getAvgLowestFive_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getAvgLowestFive_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getAvgLowestFive_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new com.libiyi.exa.common.thrift.TRAdminPaperInfoList();
  ...
  public static class getPaperQuestionDataList_args implements org.apache.thrift.TBase<getPaperQuestionDataList_args, getPaperQuestionDataList_args._Fields>, java.io.Serializable, Cloneable, Comparable<getPaperQuestionDataList_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getPaperQuestionDataList_args");
    ...
    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new getPaperQuestionDataList_argsStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new getPaperQuestionDataList_argsTupleSchemeFactory();
    ...
    static {
      ...
      tmpMap.put(_Fields.PAPER_ID, new org.apache.thrift.meta_data.FieldMetaData("paperId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getPaperQuestionDataList_args.class, metaDataMap);
    }

    public getPaperQuestionDataList_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getPaperQuestionDataList_args(getPaperQuestionDataList_args other) {
      __isset_bitfield = other.__isset_bitfield;
      this.paperId = other.paperId;
    }

    public getPaperQuestionDataList_args deepCopy() {
      return new getPaperQuestionDataList_args(this);
    }
    ...
    public getPaperQuestionDataList_args setPaperId(int paperId) {
      this.paperId = paperId;
      setPaperIdIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getPaperQuestionDataList_args)
        return this.equals((getPaperQuestionDataList_args)that);
      return false;
    }

    public boolean equals(getPaperQuestionDataList_args that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(getPaperQuestionDataList_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPaperQuestionDataList_args(");
      boolean first = true;
    ...
    private static class getPaperQuestionDataList_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getPaperQuestionDataList_argsStandardScheme getScheme() {
        return new getPaperQuestionDataList_argsStandardScheme();
      }
    }

    private static class getPaperQuestionDataList_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPaperQuestionDataList_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getPaperQuestionDataList_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPaperQuestionDataList_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getPaperQuestionDataList_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getPaperQuestionDataList_argsTupleScheme getScheme() {
        return new getPaperQuestionDataList_argsTupleScheme();
      }
    }

    private static class getPaperQuestionDataList_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<getPaperQuestionDataList_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getPaperQuestionDataList_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getPaperQuestionDataList_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.paperId = iprot.readI32();
  ...
  public static class getPaperQuestionDataList_result implements org.apache.thrift.TBase<getPaperQuestionDataList_result, getPaperQuestionDataList_result._Fields>, java.io.Serializable, Cloneable, Comparable<getPaperQuestionDataList_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getPaperQuestionDataList_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRUCT, (short)0);

    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new getPaperQuestionDataList_resultStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new getPaperQuestionDataList_resultTupleSchemeFactory();

    public com.libiyi.exa.common.thrift.TRPaperQuestionDataList success; // required
    ...
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.libiyi.exa.common.thrift.TRPaperQuestionDataList.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getPaperQuestionDataList_result.class, metaDataMap);
    }

    public getPaperQuestionDataList_result() {
    }

    public getPaperQuestionDataList_result(
      com.libiyi.exa.common.thrift.TRPaperQuestionDataList success)
    {
      this();
      this.success = success;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getPaperQuestionDataList_result(getPaperQuestionDataList_result other) {
      if (other.isSetSuccess()) {
        this.success = new com.libiyi.exa.common.thrift.TRPaperQuestionDataList(other.success);
      }
    }

    public getPaperQuestionDataList_result deepCopy() {
      return new getPaperQuestionDataList_result(this);
    }
    ...
    public com.libiyi.exa.common.thrift.TRPaperQuestionDataList getSuccess() {
      return this.success;
    }

    public getPaperQuestionDataList_result setSuccess(com.libiyi.exa.common.thrift.TRPaperQuestionDataList success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((com.libiyi.exa.common.thrift.TRPaperQuestionDataList)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getPaperQuestionDataList_result)
        return this.equals((getPaperQuestionDataList_result)that);
      return false;
    }

    public boolean equals(getPaperQuestionDataList_result that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(getPaperQuestionDataList_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getPaperQuestionDataList_result(");
      boolean first = true;
    ...
    private static class getPaperQuestionDataList_resultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getPaperQuestionDataList_resultStandardScheme getScheme() {
        return new getPaperQuestionDataList_resultStandardScheme();
      }
    }

    private static class getPaperQuestionDataList_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getPaperQuestionDataList_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getPaperQuestionDataList_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new com.libiyi.exa.common.thrift.TRPaperQuestionDataList();
                struct.success.read(iprot);
                struct.setSuccessIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPaperQuestionDataList_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getPaperQuestionDataList_resultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public getPaperQuestionDataList_resultTupleScheme getScheme() {
        return new getPaperQuestionDataList_resultTupleScheme();
      }
    }

    private static class getPaperQuestionDataList_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getPaperQuestionDataList_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getPaperQuestionDataList_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getPaperQuestionDataList_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new com.libiyi.exa.common.thrift.TRPaperQuestionDataList();
