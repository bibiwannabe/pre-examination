...
public class TPracticeRecordAndPaperInfo implements org.apache.thrift.TBase<TPracticeRecordAndPaperInfo, TPracticeRecordAndPaperInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TPracticeRecordAndPaperInfo> {
  ...
  public TPracticeRecordAndPaperInfo setPaperName(String paperName) {
    this.paperName = paperName;
    return this;
  }
  ...
  public int compareTo(TPracticeRecordAndPaperInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetAvgCounts()).compareTo(other.isSetAvgCounts());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAvgCounts()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TPracticeRecordAndPaperInfo(");
    boolean first = true;
