...
public class TRAdminQuestionSearchList implements org.apache.thrift.TBase<TRAdminQuestionSearchList, TRAdminQuestionSearchList._Fields>, java.io.Serializable, Cloneable, Comparable<TRAdminQuestionSearchList> {
  ...
  public int compareTo(TRAdminQuestionSearchList other) {
    ...
    lastComparison = Boolean.valueOf(isSetAdminQuestionInfoList()).compareTo(other.isSetAdminQuestionInfoList());
    if (lastComparison != 0) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TRAdminQuestionSearchList(");
    boolean first = true;
