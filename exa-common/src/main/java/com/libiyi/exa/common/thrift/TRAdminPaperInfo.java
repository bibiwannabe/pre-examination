...
public class TRAdminPaperInfo implements org.apache.thrift.TBase<TRAdminPaperInfo, TRAdminPaperInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TRAdminPaperInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TRAdminPaperInfo");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TRAdminPaperInfoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TRAdminPaperInfoTupleSchemeFactory();

  public TPaperInfo paperInfo; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TRAdminPaperInfo.class, metaDataMap);
  }

  public TRAdminPaperInfo() {
  }

  public TRAdminPaperInfo(
    TPaperInfo paperInfo,
    TRResponse response)
  {
    this();
   ...
   */
  public TRAdminPaperInfo(TRAdminPaperInfo other) {
    if (other.isSetPaperInfo()) {
      this.paperInfo = new TPaperInfo(other.paperInfo);
    }
  ...
  public TRAdminPaperInfo deepCopy() {
    return new TRAdminPaperInfo(this);
  }
  ...
  public TPaperInfo getPaperInfo() {
    return this.paperInfo;
  }

  public TRAdminPaperInfo setPaperInfo(TPaperInfo paperInfo) {
    this.paperInfo = paperInfo;
    return this;
  }
  ...
  public TRAdminPaperInfo setResponse(TRResponse response) {
    this.response = response;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TRAdminPaperInfo)
      return this.equals((TRAdminPaperInfo)that);
    return false;
  }

  public boolean equals(TRAdminPaperInfo that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TRAdminPaperInfo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TRAdminPaperInfo(");
    boolean first = true;
  ...
  private static class TRAdminPaperInfoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRAdminPaperInfoStandardScheme getScheme() {
      return new TRAdminPaperInfoStandardScheme();
    }
  }

  private static class TRAdminPaperInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<TRAdminPaperInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TRAdminPaperInfo struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // PAPER_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.paperInfo = new TPaperInfo();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRAdminPaperInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TRAdminPaperInfoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TRAdminPaperInfoTupleScheme getScheme() {
      return new TRAdminPaperInfoTupleScheme();
    }
  }

  private static class TRAdminPaperInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRAdminPaperInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TRAdminPaperInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TRAdminPaperInfo struct) throws org.apache.thrift.TException {
