...
public class TEvaluateResult implements org.apache.thrift.TBase<TEvaluateResult, TEvaluateResult._Fields>, java.io.Serializable, Cloneable, Comparable<TEvaluateResult> {
  ...
  public String wrongAnswer; // required
  ...
  public TEvaluateResult setContent(String content) {
    this.content = content;
    return this;
  }
  ...
  public TEvaluateResult setOptions(String options) {
    this.options = options;
    return this;
  }
  ...
  public TEvaluateResult setAnswer(String answer) {
    this.answer = answer;
    return this;
  }
  ...
  public TEvaluateResult setWrongAnswer(String wrongAnswer) {
    this.wrongAnswer = wrongAnswer;
    return this;
  }
  ...
  public int compareTo(TEvaluateResult other) {
    ...
    lastComparison = Boolean.valueOf(isSetWrongAnswer()).compareTo(other.isSetWrongAnswer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWrongAnswer()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TEvaluateResult(");
    boolean first = true;
