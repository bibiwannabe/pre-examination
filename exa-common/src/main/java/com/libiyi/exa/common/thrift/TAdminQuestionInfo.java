...
public class TAdminQuestionInfo implements org.apache.thrift.TBase<TAdminQuestionInfo, TAdminQuestionInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TAdminQuestionInfo> {
  ...
  public TAdminQuestionInfo setContent(String content) {
    this.content = content;
    return this;
  }
  ...
  public TAdminQuestionInfo setOptions(String options) {
    this.options = options;
    return this;
  }
  ...
  public TAdminQuestionInfo setAnswer(String answer) {
    this.answer = answer;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TAdminQuestionInfo(");
    boolean first = true;
