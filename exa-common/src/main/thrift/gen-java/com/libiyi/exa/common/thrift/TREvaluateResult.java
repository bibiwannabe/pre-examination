...
public class TREvaluateResult implements org.apache.thrift.TBase<TREvaluateResult, TREvaluateResult._Fields>, java.io.Serializable, Cloneable, Comparable<TREvaluateResult> {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case GRADES:
      if (value == null) {
        ...
        setGrades((java.lang.Integer)value);
      }
      break;
  ...
  public int compareTo(TREvaluateResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetTPortalPaperAndQuestion()).compareTo(other.isSetTPortalPaperAndQuestion());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetGrades()).compareTo(other.isSetGrades());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetGrades()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TREvaluateResult(");
    boolean first = true;
