...
public class TPortalQuestionPointsAndInfoList implements org.apache.thrift.TBase<TPortalQuestionPointsAndInfoList, TPortalQuestionPointsAndInfoList._Fields>, java.io.Serializable, Cloneable, Comparable<TPortalQuestionPointsAndInfoList> {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPortalQuestionPointsAndInfoList(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.questionInfoList = new java.util.ArrayList<TPortalQuestionInfo>(_list56.size);
                TPortalQuestionInfo _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = new TPortalQuestionInfo();
                  _elem57.read(iprot);
                  struct.questionInfoList.add(_elem57);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPortalQuestionPointsAndInfoList struct) throws org.apache.thrift.TException {
      ...
      if (struct.questionInfoList != null) {
        oprot.writeFieldBegin(QUESTION_INFO_LIST_FIELD_DESC);
        {
          ...
          for (TPortalQuestionInfo _iter59 : struct.questionInfoList)
          {
            _iter59.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetQuestionInfoList()) {
        {
          ...
          for (TPortalQuestionInfo _iter60 : struct.questionInfoList)
          {
            _iter60.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.questionInfoList = new java.util.ArrayList<TPortalQuestionInfo>(_list61.size);
          TPortalQuestionInfo _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = new TPortalQuestionInfo();
            _elem62.read(iprot);
            struct.questionInfoList.add(_elem62);
          }
        }
        struct.setQuestionInfoListIsSet(true);
      }
