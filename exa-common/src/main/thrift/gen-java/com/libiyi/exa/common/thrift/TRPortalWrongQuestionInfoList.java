...
public class TRPortalWrongQuestionInfoList implements org.apache.thrift.TBase<TRPortalWrongQuestionInfoList, TRPortalWrongQuestionInfoList._Fields>, java.io.Serializable, Cloneable, Comparable<TRPortalWrongQuestionInfoList> {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TRPortalWrongQuestionInfoList(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.questionInfoList = new java.util.ArrayList<TPortalWrongQuestionInfo>(_list24.size);
                TPortalWrongQuestionInfo _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new TPortalWrongQuestionInfo();
                  _elem25.read(iprot);
                  struct.questionInfoList.add(_elem25);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRPortalWrongQuestionInfoList struct) throws org.apache.thrift.TException {
      ...
      if (struct.questionInfoList != null) {
        oprot.writeFieldBegin(QUESTION_INFO_LIST_FIELD_DESC);
        {
          ...
          for (TPortalWrongQuestionInfo _iter27 : struct.questionInfoList)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetQuestionInfoList()) {
        {
          ...
          for (TPortalWrongQuestionInfo _iter28 : struct.questionInfoList)
          {
            _iter28.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.questionInfoList = new java.util.ArrayList<TPortalWrongQuestionInfo>(_list29.size);
          TPortalWrongQuestionInfo _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new TPortalWrongQuestionInfo();
            _elem30.read(iprot);
            struct.questionInfoList.add(_elem30);
          }
        }
        struct.setQuestionInfoListIsSet(true);
      }
