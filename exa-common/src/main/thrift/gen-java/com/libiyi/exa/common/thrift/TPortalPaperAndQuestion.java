...
public class TPortalPaperAndQuestion implements org.apache.thrift.TBase<TPortalPaperAndQuestion, TPortalPaperAndQuestion._Fields>, java.io.Serializable, Cloneable, Comparable<TPortalPaperAndQuestion> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPortalPaperAndQuestion");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TPortalPaperAndQuestionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TPortalPaperAndQuestionTupleSchemeFactory();

  public int id; // required
  public int subjectId; // required
  public java.lang.String name; // required
  public TEvaluateResultListAndPoints choice; // required
  public TEvaluateResultListAndPoints selection; // required
  public TEvaluateResultListAndPoints filling; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.CHOICE, new org.apache.thrift.meta_data.FieldMetaData("choice", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "TEvaluateResultListAndPoints")));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPortalPaperAndQuestion.class, metaDataMap);
  }

  public TPortalPaperAndQuestion() {
  }
  ...
  public TPortalPaperAndQuestion(
    ...
    TEvaluateResultListAndPoints choice,
    TEvaluateResultListAndPoints selection,
    TEvaluateResultListAndPoints filling)
  {
    this();
    this.id = id;
    setIdIsSet(true);
   ...
   */
  public TPortalPaperAndQuestion(TPortalPaperAndQuestion other) {
    ...
    if (other.isSetChoice()) {
      this.choice = new TEvaluateResultListAndPoints(other.choice);
    }
    if (other.isSetSelection()) {
      this.selection = new TEvaluateResultListAndPoints(other.selection);
    }
    if (other.isSetFilling()) {
      this.filling = new TEvaluateResultListAndPoints(other.filling);
    }
  }

  public TPortalPaperAndQuestion deepCopy() {
    return new TPortalPaperAndQuestion(this);
  }
  ...
  public TPortalPaperAndQuestion setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TPortalPaperAndQuestion setSubjectId(int subjectId) {
    this.subjectId = subjectId;
    setSubjectIdIsSet(true);
    return this;
  }
  ...
  public TPortalPaperAndQuestion setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public TEvaluateResultListAndPoints getChoice() {
    return this.choice;
  }

  public TPortalPaperAndQuestion setChoice(TEvaluateResultListAndPoints choice) {
    this.choice = choice;
    return this;
  }
  ...
  public TEvaluateResultListAndPoints getSelection() {
    return this.selection;
  }

  public TPortalPaperAndQuestion setSelection(TEvaluateResultListAndPoints selection) {
    this.selection = selection;
    return this;
  }
  ...
  public TEvaluateResultListAndPoints getFilling() {
    return this.filling;
  }

  public TPortalPaperAndQuestion setFilling(TEvaluateResultListAndPoints filling) {
    this.filling = filling;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case CHOICE:
      if (value == null) {
        ...
        setChoice((TEvaluateResultListAndPoints)value);
      }
      break;
    ...
    case SELECTION:
      if (value == null) {
        ...
        setSelection((TEvaluateResultListAndPoints)value);
      }
      break;
    ...
    case FILLING:
      if (value == null) {
        ...
        setFilling((TEvaluateResultListAndPoints)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TPortalPaperAndQuestion)
      return this.equals((TPortalPaperAndQuestion)that);
    return false;
  }

  public boolean equals(TPortalPaperAndQuestion that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TPortalPaperAndQuestion other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TPortalPaperAndQuestion(");
    boolean first = true;
  ...
  private static class TPortalPaperAndQuestionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPortalPaperAndQuestionStandardScheme getScheme() {
      return new TPortalPaperAndQuestionStandardScheme();
    }
  }

  private static class TPortalPaperAndQuestionStandardScheme extends org.apache.thrift.scheme.StandardScheme<TPortalPaperAndQuestion> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPortalPaperAndQuestion struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // CHOICE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.choice = new TEvaluateResultListAndPoints();
          ...
          case 5: // SELECTION
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.selection = new TEvaluateResultListAndPoints();
          ...
          case 6: // FILLING
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.filling = new TEvaluateResultListAndPoints();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPortalPaperAndQuestion struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TPortalPaperAndQuestionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TPortalPaperAndQuestionTupleScheme getScheme() {
      return new TPortalPaperAndQuestionTupleScheme();
    }
  }

  private static class TPortalPaperAndQuestionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TPortalPaperAndQuestion> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPortalPaperAndQuestion struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPortalPaperAndQuestion struct) throws org.apache.thrift.TException {
