...
public class TEvaluateResultListAndPoints implements org.apache.thrift.TBase<TEvaluateResultListAndPoints, TEvaluateResultListAndPoints._Fields>, java.io.Serializable, Cloneable, Comparable<TEvaluateResultListAndPoints> {
  ...
  public int compareTo(TEvaluateResultListAndPoints other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetQuestionAndResult()).compareTo(other.isSetQuestionAndResult());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetQuestionAndResult()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TEvaluateResultListAndPoints(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.questionAndResult = new java.util.ArrayList<TEvaluateResult>(_list94.size);
                TEvaluateResult _elem95;
                for (int _i96 = 0; _i96 < _list94.size; ++_i96)
                {
                  _elem95 = new TEvaluateResult();
                  _elem95.read(iprot);
                  struct.questionAndResult.add(_elem95);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TEvaluateResultListAndPoints struct) throws org.apache.thrift.TException {
      ...
      if (struct.questionAndResult != null) {
        oprot.writeFieldBegin(QUESTION_AND_RESULT_FIELD_DESC);
        {
          ...
          for (TEvaluateResult _iter97 : struct.questionAndResult)
          {
            _iter97.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetQuestionAndResult()) {
        {
          ...
          for (TEvaluateResult _iter98 : struct.questionAndResult)
          {
            _iter98.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.questionAndResult = new java.util.ArrayList<TEvaluateResult>(_list99.size);
          TEvaluateResult _elem100;
          for (int _i101 = 0; _i101 < _list99.size; ++_i101)
          {
            _elem100 = new TEvaluateResult();
            _elem100.read(iprot);
            struct.questionAndResult.add(_elem100);
          }
        }
        struct.setQuestionAndResultIsSet(true);
      }
