...
public class TRPortalPaperInfoList implements org.apache.thrift.TBase<TRPortalPaperInfoList, TRPortalPaperInfoList._Fields>, java.io.Serializable, Cloneable, Comparable<TRPortalPaperInfoList> {
  ...
  public int compareTo(TRPortalPaperInfoList other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetPaperInfoList()).compareTo(other.isSetPaperInfoList());
    if (lastComparison != 0) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TRPortalPaperInfoList(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.paperInfoList = new java.util.ArrayList<TPortalPaperInfo>(_list40.size);
                TPortalPaperInfo _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new TPortalPaperInfo();
                  _elem41.read(iprot);
                  struct.paperInfoList.add(_elem41);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRPortalPaperInfoList struct) throws org.apache.thrift.TException {
      ...
      if (struct.paperInfoList != null) {
        oprot.writeFieldBegin(PAPER_INFO_LIST_FIELD_DESC);
        {
          ...
          for (TPortalPaperInfo _iter43 : struct.paperInfoList)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetPaperInfoList()) {
        {
          ...
          for (TPortalPaperInfo _iter44 : struct.paperInfoList)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.paperInfoList = new java.util.ArrayList<TPortalPaperInfo>(_list45.size);
          TPortalPaperInfo _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new TPortalPaperInfo();
            _elem46.read(iprot);
            struct.paperInfoList.add(_elem46);
          }
        }
        struct.setPaperInfoListIsSet(true);
      }
