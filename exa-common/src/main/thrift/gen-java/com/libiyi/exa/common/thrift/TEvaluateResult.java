...
public class TEvaluateResult implements org.apache.thrift.TBase<TEvaluateResult, TEvaluateResult._Fields>, java.io.Serializable, Cloneable, Comparable<TEvaluateResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TEvaluateResult");
  ...
  private static final org.apache.thrift.protocol.TField WRONG_ANSWER_FIELD_DESC = new org.apache.thrift.protocol.TField("wrongAnswer", org.apache.thrift.protocol.TType.STRING, (short)7);
  private static final org.apache.thrift.protocol.TField IS_CORRECT_FIELD_DESC = new org.apache.thrift.protocol.TField("isCorrect", org.apache.thrift.protocol.TType.BOOL, (short)8);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TEvaluateResultStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TEvaluateResultTupleSchemeFactory();
  ...
  public java.lang.String wrongAnswer; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    WRONG_ANSWER((short)7, "wrongAnswer"),
    IS_CORRECT((short)8, "isCorrect");
  ...
  private static final int __ISCORRECT_ISSET_ID = 3;
  ...
  static {
    ...
    tmpMap.put(_Fields.ANSWER, new org.apache.thrift.meta_data.FieldMetaData("answer", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.WRONG_ANSWER, new org.apache.thrift.meta_data.FieldMetaData("wrongAnswer", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TEvaluateResult.class, metaDataMap);
  }

  public TEvaluateResult() {
  }
   ...
   */
  public TEvaluateResult(TEvaluateResult other) {
    ...
    if (other.isSetWrongAnswer()) {
      this.wrongAnswer = other.wrongAnswer;
    }
    this.isCorrect = other.isCorrect;
  }

  public TEvaluateResult deepCopy() {
    return new TEvaluateResult(this);
  }
  ...
  public TEvaluateResult setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TEvaluateResult setSubjectId(int subjectId) {
    this.subjectId = subjectId;
    setSubjectIdIsSet(true);
    return this;
  }
  ...
  public TEvaluateResult setType(int type) {
    this.type = type;
    setTypeIsSet(true);
    return this;
  }
  ...
  public TEvaluateResult setContent(java.lang.String content) {
    this.content = content;
    return this;
  }
  ...
  public TEvaluateResult setOptions(java.lang.String options) {
    this.options = options;
    return this;
  }
  ...
  public TEvaluateResult setAnswer(java.lang.String answer) {
    this.answer = answer;
    return this;
  }
  ...
  public TEvaluateResult setWrongAnswer(java.lang.String wrongAnswer) {
    this.wrongAnswer = wrongAnswer;
    return this;
  }

  public void unsetWrongAnswer() {
    this.wrongAnswer = null;
  }

  /** Returns true if field wrongAnswer is set (has been assigned a value) and false otherwise */
  public boolean isSetWrongAnswer() {
    return this.wrongAnswer != null;
  }

  public void setWrongAnswerIsSet(boolean value) {
    if (!value) {
      this.wrongAnswer = null;
    }
  }
  ...
  public TEvaluateResult setIsCorrect(boolean isCorrect) {
    this.isCorrect = isCorrect;
    setIsCorrectIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case WRONG_ANSWER:
      if (value == null) {
        ...
        setWrongAnswer((java.lang.String)value);
      }
      break;
    ...
    case IS_CORRECT:
      if (value == null) {
        ...
        setIsCorrect((java.lang.Boolean)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TEvaluateResult)
      return this.equals((TEvaluateResult)that);
    return false;
  }

  public boolean equals(TEvaluateResult that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_wrongAnswer = true && this.isSetWrongAnswer();
    boolean that_present_wrongAnswer = true && that.isSetWrongAnswer();
    if (this_present_wrongAnswer || that_present_wrongAnswer) {
      if (!(this_present_wrongAnswer && that_present_wrongAnswer))
        return false;
      if (!this.wrongAnswer.equals(that.wrongAnswer))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetWrongAnswer()) ? 131071 : 524287);
    if (isSetWrongAnswer())
      hashCode = hashCode * 8191 + wrongAnswer.hashCode();

    hashCode = hashCode * 8191 + ((isCorrect) ? 131071 : 524287);

    return hashCode;
  }

  @Override
  public int compareTo(TEvaluateResult other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetWrongAnswer()).compareTo(other.isSetWrongAnswer());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWrongAnswer()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.wrongAnswer, other.wrongAnswer);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TEvaluateResult(");
    boolean first = true;
  ...
  private static class TEvaluateResultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TEvaluateResultStandardScheme getScheme() {
      return new TEvaluateResultStandardScheme();
    }
  }

  private static class TEvaluateResultStandardScheme extends org.apache.thrift.scheme.StandardScheme<TEvaluateResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TEvaluateResult struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 7: // WRONG_ANSWER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.wrongAnswer = iprot.readString();
              struct.setWrongAnswerIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TEvaluateResult struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.wrongAnswer != null) {
        oprot.writeFieldBegin(WRONG_ANSWER_FIELD_DESC);
        oprot.writeString(struct.wrongAnswer);
        oprot.writeFieldEnd();
      }
  ...
  private static class TEvaluateResultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TEvaluateResultTupleScheme getScheme() {
      return new TEvaluateResultTupleScheme();
    }
  }

  private static class TEvaluateResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TEvaluateResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TEvaluateResult struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TEvaluateResult struct) throws org.apache.thrift.TException {
