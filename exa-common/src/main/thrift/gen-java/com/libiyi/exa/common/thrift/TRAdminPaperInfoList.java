...
public class TRAdminPaperInfoList implements org.apache.thrift.TBase<TRAdminPaperInfoList, TRAdminPaperInfoList._Fields>, java.io.Serializable, Cloneable, Comparable<TRAdminPaperInfoList> {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TRAdminPaperInfoList(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.paperInfoList = new java.util.ArrayList<TPaperInfo>(_list32.size);
                TPaperInfo _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new TPaperInfo();
                  _elem33.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRAdminPaperInfoList struct) throws org.apache.thrift.TException {
      ...
      if (struct.paperInfoList != null) {
        oprot.writeFieldBegin(PAPER_INFO_LIST_FIELD_DESC);
        {
          ...
          for (TPaperInfo _iter35 : struct.paperInfoList)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetPaperInfoList()) {
        {
          ...
          for (TPaperInfo _iter36 : struct.paperInfoList)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.paperInfoList = new java.util.ArrayList<TPaperInfo>(_list37.size);
          TPaperInfo _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new TPaperInfo();
            _elem38.read(iprot);
